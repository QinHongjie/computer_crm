...
<head>
	...
	<script src="<%=request.getContextPath() %>/static/js/header.js"></script>
</head>
<body>
	<!-- 粒子背景特效 -->
				...
				<div class="collapse navbar-collapse navbar-right">
					<ul class="nav navbar-nav">
						...
						<li class="login_yes" class="dropdown">
							...
							<span class="user_name"><%=userName %></span><span class="caret"></span></a>
	...
	<div id="header">
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">
						<img class="logo" data-src="<%=request.getContextPath() %>/static/img/consultancy_logo.png" alt="数码商城"/>
					</a>
				</div>
				<!-- 大屏幕顶部导航条 -->
		...
		<nav id="nav-sm" class="navbar-fixed-top" style="background: black;">
			<div class="container-fluid">
				...
				<div id="nav-top">
					...
					<div>
						<a href="#">
							<img class="logo" src="<%=request.getContextPath() %>/static/img/consultancy_logo.png" alt="数码商城"/>
						</a>
					</div>
					<!-- 搜索 -->
		...
		<div id="navbar-left">
			...
			<div>
				<a href="#">
					<img data-src="<%=request.getContextPath() %>/static/img/consultancy_logo.png" width="220px" alt="数码商城"/>
				</a>
			</div>
	...
	<!-- 右侧固定信息块 -->
		<div id="right-fixed" class="move_left">
			<div class="phone">
				<img data-src="<%=request.getContextPath() %>/static/img/right01.png" height="54px" width="170px"/>
			</div>
			<div>
				<a id="online_count_a">
			...
			<div>
				...
				<img class="scroll-top" data-src="<%=request.getContextPath() %>/static/img/right03.png" width="54px" height="54px"/>
			</div>
		</div>
	...
	//			case 0:$(".index").addClass("active");break;
			...
			$(".logout").click(function(){
				location.href="LogoutServlet.do";
			})
