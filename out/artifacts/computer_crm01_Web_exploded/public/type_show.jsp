...
<html>
<head>
	<title>数码商城 | ${requestScope.typeName }</title>
	...
	<div class="product-show">
		<div class="container">
			...
			<div class="col-md-10 col-sm-12">
				<div class="row">
					<%
						List<Map<String,String>> pageComs = (List<Map<String,String>>)request.getAttribute("pageComs");
						if(pageComs != null){
							for(Map<String,String> m : pageComs){
					%>
