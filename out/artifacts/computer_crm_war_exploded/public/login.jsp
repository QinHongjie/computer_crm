...
<body>
	<script>
	 	...
	 	*/
	 	function reCodeImg(){  
	    	$(".codeImg").attr("src","${pageContext.request.contextPath }/GetCodeServlet?r="+Math.random());
		}
 	</script>
	<!-- 	-	-	-	-	-	main body begin 	-	-	-	-	-	-->
	<div id="main" class="container">
		...
		<div class="form-signin-heading text-center">
			<a href="${pageContext.request.contextPath }/index.action">
				<img src="${pageContext.request.contextPath }/img/login_log.png" />
			</a>
			<div><font color="red"><c:out value="${message}"></c:out></font></div>
		</div>
		<!-- 登录块 -->
		<form action="${pageContext.request.contextPath }/login.do" method="post" id="form-login" class="form-signin">
			<!-- 用户名输入区 -->
			    ...
			    <div class="input-group">
					...
					<span class="input-group-btn">
						<button class="btn btn-default" type="button" onclick="reCodeImg()">
							<img class="codeImg" src="${pageContext.request.contextPath }/GetCodeServlet" alt="点击刷新" />
						</button>
					</span>
			    </div><!-- /input-group -->
			</div><!-- check_code -->
			...
			<img class="loading" src="${pageContext.request.contextPath }/img/loading.gif" />
			<div class="dsf">
				第三方账号登录：
				<a href="#">
					<img src="${pageContext.request.contextPath }/img/qq_icon.png" />
				</a>
			</div>
		...
		<!-- 注册块 -->
		<form action="${pageContext.request.contextPath }/register.do" method="post" id="form-register" class="form-signin" onsubmit="return false">
			<!-- 用户名输入区 -->
