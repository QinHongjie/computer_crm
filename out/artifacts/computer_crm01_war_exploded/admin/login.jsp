...
<body>
	<c:if test="${adminName != null }">
		<script>location.href="admin_index.jsp";</script>
	</c:if>

	<div class="container">
		<form class="form-signin" action="${pageContext.request.contextPath }/AdminLoginServlet" method="post">
			<h2 class="form-signin-heading">数码商场后台</h2>
			<!-- 管理员名输入区 -->
