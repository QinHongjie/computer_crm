...
<head>
    ...
    <script src="${pageContext.request.contextPath }/admin_js/iframeAutoHeight.js"></script>
    <script src="${pageContext.request.contextPath }/admin_js/admin_index.js"></script>
...
<body>
	<c:if test="${ADMIN_SESSION eq null }">
		<script>
			alert("登录超时，请重新登录！");
			location.href = "admin_login.action";
		</script>
	</c:if>
					...
					<ul class="nav navbar-nav navbar-right">
 						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								 ${ADMIN_SESSION.userName }<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a href="javascript:;">个人配置</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="logout.admin">注销登录</a></li>
							</ul>
						</li>
					</ul>
					<form class="navbar-form navbar-right">
						<input type="text" class="form-control" placeholder="Search..." style="opacity: 0.4;box-shadow:inset 0 0 20px black;">
					</form>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar" id="accordion">
				...
				<div class="nav nav-sidebar text-admin">
					<div class="col-sm-5 col-md-5">
						<img class="img-circle" src="${pageContext.request.contextPath }/img/head_pho.jpg" width="70px"/>
					</div>
				...
				<ul class="nav nav-sidebar panel">
					<li class="pull-down-li">
						<a role="button" href="welcome.action" target="iframe">
							控制台
				...
				<ul class="nav nav-sidebar panel">
					...
					<div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
						<ul class="nav">
							<li><a href="user_list.action" target="iframe">
								<span class="glyphicon glyphicon-menu-right"></span>
								&nbsp;用户信息管理
							</a></li>
							<li><a href="user_right.action" target="iframe">
								<span class="glyphicon glyphicon-menu-right"></span>
								&nbsp;用户权限管理
							</a></li>
						</ul>
		    	...
		    	<ul class="nav nav-sidebar panel">
					...
					<div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
						<ul class="nav">
							<li><a href="product_list.action" target="iframe">
								<span class="glyphicon glyphicon-menu-right"></span>
								&nbsp;商品信息管理
							</a></li>
							<li><a href="product_type.action" target="iframe">
								<span class="glyphicon glyphicon-menu-right"></span>
								&nbsp;商品类型管理
							</a></li>
							<li><a href="#">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<iframe id="external_frame" src="welcome.action" name="iframe" width="100%" height="660px"  frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
				</iframe>
			</div>
